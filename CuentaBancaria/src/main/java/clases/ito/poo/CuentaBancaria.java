...
public class CuentaBancaria implements Comparable<CuentaBancaria>{
	...
	public CuentaBancaria(long numCuenta, String nomCliente, float saldo, LocalDate fechaApertura) {
		super();
		if(numCuenta<999)
			throw new RuntimeException("　El numero de cuenta debe de ser mayor a 9999!!");
		this.numCuenta = numCuenta;
		this.nomCliente = nomCliente;
		
		if(saldo<5000) {
			throw new RuntimeException("　El Saldo minimo para abrir la cuenta debed e ser de: $5,000.00!!");}
		this.saldo = saldo;
