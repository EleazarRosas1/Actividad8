...
public class Aplicacion {
	...
	c.addItem(new CuentaBancaria(1066,"Elias rojas",34000,LocalDate.of(2021, 4, 24)));
	c.addItem(new CuentaBancaria(1034,"Mariana Rodriguez",46000,LocalDate.of(2021, 5, 30)));
	c.addItem(new CuentaBancaria(1032,"Sofia Morales",70000,LocalDate.of(2021, 12, 2)));
	c.addItem(new CuentaBancaria(1031,"Karolina Lopez",18000,LocalDate.of(2021, 3, 12)));
	c.addItem(new CuentaBancaria(1029,"Jocelyn Flores",30000,LocalDate.of(2021, 2, 1)));
	c.addItem(new CuentaBancaria(1030,"Jocelyn Flores",6000,LocalDate.of(2021, 2, 1)));
	System.out.println(c.isFree());
